        ...
        <span>
            ...
            {settings.bookingFlow === "0" && auth.profile.usertype === 'customer' ? 
             ...
             <RadioGroup row name="bookingFlow" value={deliveryWithBid} onChange={handleChange}>
               <FormControlLabel key={"key0"} value={0} control={<Radio />} label={t('system_price')} />
               <FormControlLabel key={"key1"} value={1} control={<Radio />} label={t('bid')} />
             </RadioGroup>
           </Grid>
            :null}
        </span>
    ...
    <Grid item xs={12} sm={12} md={12} lg={12} style={{textAlign:isRTL==='rtl'?'right':'left'}}>
      <FormControl component="fieldset">
        <RadioGroup  row name="booking_type" value={data} onChange={handleChange}>
          <FormControlLabel key={"key0"} value={0} control={<Radio />} label={t('system_price_with_bid')} />
          <FormControlLabel key={"key1"} value={1} control={<Radio />} label={t('system_price')} />
          <FormControlLabel key={"key2"} value={2} control={<Radio />} label={t('bid')} />
        </RadioGroup>
      </FormControl>
    </Grid>
  </span>
